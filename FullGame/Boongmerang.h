...
#define BOONGMERANG_TIME_ATTACK 2500


class Boongmerang : public Weapon
{
	static Boongmerang* __instance;
	DWORD start_attack;
	float leftLimit;
	float rightLimit;
	int turn;
public:
	...
	static Boongmerang* GetInstance();
	Boongmerang();
