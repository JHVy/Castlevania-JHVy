...
bool ItemMoney::isStartShowHiden = false;

void ItemMoney::GetBoundingBox(float& left, float& top, float& right, float& bottom)
{
...
void ItemMoney::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
	...
	{
		if (y >= destination_y && ItemMoney::IsStart())
		{
			y -= 0.1f * dt;
		}
	}
